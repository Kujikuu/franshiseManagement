                    ...
                    <div class="table-responsive">
                        <table class="table table-head-custom table-vertical-center order-table kt_datatable" id="kt_advance_table_widget_1">
                            ...
                            <tr>
                                ...
                                <td >
                                    <span class="text-muted  font-weight-bold">TR<?php echo e($row['id']); ?>  </span>
                                </td>

                                <td >
                                    <span class="text-muted  font-weight-bold">A<?php echo e($row->user->id); ?></span>
                                </td>
                                <td >
                                ...
                                <td >
                                    <span class="text-muted  font-weight-bold"><?php echo e($row->user->type); ?></span>
                                </td>

                                <td >
                                    <span class="text-muted  font-weight-bold"><?php echo e($row['description']); ?></span>
                                </td>
                                ...
                                <td >
                                    <span class="text-muted  font-weight-bold"><?php echo e($row['created_at']); ?>  </span>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#delete_record_modal" data-action="<?php echo e(route('technical_request.delete' , $row->id)); ?>" data-id="<?php echo e($row->id); ?>" class="open_delete_modal btn btn-icon btn-light btn-hover-primary btn-sm">
                                        <span class="svg-icon svg-icon-md svg-icon-primary">
            ...
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form" method="POST" action="<?php echo e(route('technical_request.store')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <select name="status" class="form-control">
                                            ...
                                            <option <?php if($row['status'] == "completed"): ?> selected <?php endif; ?> >completed</option>
                                        </select>
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ahmedafifi/Desktop/franshiseManagement/resources/views/dashboard/technical_requests.blade.php ENDPATH**/ ?>