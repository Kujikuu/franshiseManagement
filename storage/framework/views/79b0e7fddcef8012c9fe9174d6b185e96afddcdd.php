        ...
        <div class="login-aside d-flex flex-column flex-row-auto">
            ...
            <div class="d-flex flex-column-auto flex-column pt-15 px-30">
                ...
                <a href="<?php echo e(url('/')); ?>" class="login-logo text-center pt-lg-25 pb-10">
                    <img src="<?php echo e(asset('uploads/')); ?>" class="max-h-70px" alt="" />
                </a>
                <!--end::Aside header-->
                <!--begin: Wizard Nav-->
        ...
        <div class="login-content flex-column-fluid d-flex flex-column p-10">
            ...
            <div class="d-flex flex-row-fluid flex-center">
                ...
                <div class="login-form login-form-signup">
                    ...
                    <form id="kt_login_signup_form" method="POST" action="<?php echo e(route('register')); ?>" enctype="multipart/form-data" >
                    <?php echo csrf_field(); ?>
                    <!--begin: Wizard Step 1-->
                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                            ...
                            <div class="form-group firstcont">
                                ...
                                <input  style="padding: 12px" type="text" id="first_name"  name="name" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6 <?php $__errorArgs = ['name'];
...
<!--end::Body-->
</html><?php /**PATH /Users/ahmedafifi/Desktop/franshiseManagement/resources/views/auth/register.blade.php ENDPATH**/ ?>