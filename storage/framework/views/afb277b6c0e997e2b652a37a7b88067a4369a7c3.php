        ...
        <div class="login-aside d-flex flex-column flex-row-auto">
            ...
            <div class="d-flex flex-column-auto flex-column pt-15 px-30">
                ...
                <a href="<?php echo e(url('/')); ?>" class="login-logo text-center pt-lg-25 pb-10">
                    <img width="200px" src="<?php echo e(asset('logo.png')); ?>" class="max-h-100px" alt="" />
                </a>
        ...
        <div class="login-content flex-column-fluid d-flex flex-column p-10">
            ...
            <div class="d-flex flex-row-fluid flex-center">
                ...
                <div class="login-form login-form-signup">
                    <!--begin::Form-->
                    <form id="kt_login_signup_form" method="POST" action="<?php echo e(route('register.franchisor')); ?>" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="email" type="email" style="padding: 12px" class="form-control h-auto border-0 rounded-lg font-size-h6 <?php $__errorArgs = ['email'];
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="password" type="password" style="padding: 12px" class="form-control h-auto rounded-lg border-0 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<!--end::Body-->
</html><?php /**PATH D:\Laravel pros\franshiseManagement\resources\views/auth/register_franchisor.blade.php ENDPATH**/ ?>