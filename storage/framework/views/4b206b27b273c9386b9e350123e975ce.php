                                ...
                                <div class="mt-n25">
                                    ...
                                    <div class="row m-0">
                                        ...
                                        <div class="text-center col bg-white px-6 py-8 rounded-xl mr-7 mb-7">
                                            <span class="svg-icon svg-icon-3x svg-icon-dark d-block my-2">
                                                ...
                                                <a href="" class="text-dark font-weight-bolder font-size-h2">
                                                    <?php echo e($data['totalFranchisees'] ?? 0); ?> Total Franchise</a>
                                        </div>
                                        ...
                                        <div class="text-center col bg-white px-6 py-8 rounded-xl mr-7 mb-7">
                                            ...
                                            <a href="" class="text-dark font-weight-bolder font-size-h2">
                                                $<?php echo e(number_format($data['totalSales'] ?? 0, 2)); ?> Total Sales</a>
                                        </div>
                                        ...
                                        <div class="text-center col bg-white px-6 py-8 rounded-xl mr-7 mb-7">
                                            ...
                                            <a href="" class="text-dark font-weight-bolder font-size-h2">
                                                $<?php echo e(number_format($data['totalRoyalties'] ?? 0, 2)); ?> Total Royalty</a>
                                        </div>
                        ...
                        <div class="card-body py-0">
                            ...
                            <div class="table-responsive">
                                <table class="table table-head-custom table-vertical-center order-table kt_datatable" id="kt_advance_table_widget_1">
                                    ...
                                    <tbody>
                                    <?php if(isset($data['franchisors']) && $data['franchisors']->count() > 0): ?>
                                        <?php $__currentLoopData = $data['franchisors']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $franchisor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td>
                                                    <span class="text-muted font-weight-bold">A<?php echo e($franchisor->id); ?></span>
                                                </td>
                                                <td>
                                                    <span class="text-muted font-weight-bold"><?php echo e($franchisor->brand_name ?? 'N/A'); ?></span>
                                                </td>
                                                <td>
                                                    <span class="text-muted font-weight-bold"><?php echo e($franchisor->name); ?></span>
                                                </td>
                                                <td>
                                                    <span class="text-muted font-weight-bold"><?php echo e($franchisor->email); ?></span>
                                                </td>
                                                <td>
                                                    <span class="text-muted font-weight-bold"><?php echo e($franchisor->city ?? 'N/A'); ?></span>
                                                </td>
                                                <td>
                                                    <span class="text-muted font-weight-bold">$<?php echo e(number_format($franchisor->getTotalSales(), 2)); ?></span>
                                                </td>
                                                <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ahmedafifi/Desktop/franshiseManagement/resources/views/dashboard/index.blade.php ENDPATH**/ ?>