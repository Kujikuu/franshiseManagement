        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h2 style="color: #3a384e"  class="d-flex align-items-center font-weight-bolder my-1 mr-3">Cities</h2>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-head-custom table-vertical-center order-table kt_datatable" id="kt_advance_table_widget_1">
                            ...
                            <tr>
                                ...
                                <td >
                                    <span class="text-muted  font-weight-bold"><?php echo e($row['name'] . ', ' . $row['country']); ?>  </span>
                                </td>

                                <td >
                                    <span class="text-muted  font-weight-bold"><?php echo e($row['name_ar']); ?></span>
                                </td>

                                <td >
                                    <img style="width: 20%" src="<?php echo e(asset($row['image_url'])); ?>">
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#delete_record_modal" data-action="<?php echo e(route('city.delete' , $row->id)); ?>" data-id="<?php echo e($row->id); ?>" class="open_delete_modal btn btn-icon btn-light btn-hover-primary btn-sm">
                                        <span class="svg-icon svg-icon-md svg-icon-primary">
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form class="form" method="POST" action="<?php echo e(route('city.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label text-right">Name(Arabic):</label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="name_ar" placeholder="Enter Name in Arabic Here"   />
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label text-right">Image: (optional)</label>
                                <div class="col-lg-8">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label text-right">is Destination </label>
                                <div class="col-lg-8">
                                    <select name="is_dest" class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="checkbox">
                                    Manual Save
                                    <input type="checkbox" name="manual_save">
                        ...
                        <form class="form" method="POST" action="<?php echo e(route('city.store')); ?>" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label text-right">Name:</label>
                                    <div class="col-lg-8">
                                        <input disabled type="text" class="form-control" name="name" placeholder="Enter Name Here" value="<?php echo e($row['name']); ?>"  required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label text-right">Name(Arabic):</label>
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="name_ar" placeholder="Enter Name in Arabic Here" value="<?php echo e($row['name_ar']); ?>"  />
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <select name="is_dest" class="form-control">
                                            <option <?php if($row['is_dest']): ?> selected <?php endif; ?> value="1">yes</option>
                                            <option <?php if(!$row['is_dest']): ?> selected <?php endif; ?>  value="0">no</option>
                                        </select>
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel pros\travelAPI\resources\views/dashboard/cities.blade.php ENDPATH**/ ?>