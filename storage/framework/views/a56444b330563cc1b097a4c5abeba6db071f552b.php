                                        ...
                                        <form class="form" method="POST" action="" enctype="multipart/form-data">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label>ID </label>
                                                    <input type="text" class="form-control" name="id" value="A<?php echo e($info['id']); ?>" disabled readonly placeholder="">
                                                </div>

                                                <div class="form-group">
                                                    <label>Branch Name </label>
                                                    <input type="text" class="form-control" name="brand_name" value="<?php echo e($info['brand_name']); ?>" placeholder="">
                                                </div>
                                                <div class="form-group">
                                                    <label>Email </label>
                                                    <input type="email" class="form-control" name="email" value="<?php echo e($info['email']); ?>" placeholder="">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="contact_number" value="<?php echo e($info['phone']); ?>" placeholder="">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control " name="province" value="<?php echo e($info['province']); ?>">
                                                </div>

                                                <div class="form-group">

                                                    <label  class=" form-control-label">City</label>
                                                    <input type="text" class="form-control" name="city" value="<?php echo e($info['city']); ?>">
                                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel pros\franshiseManagement\resources\views/dashboard/single_unit.blade.php ENDPATH**/ ?>