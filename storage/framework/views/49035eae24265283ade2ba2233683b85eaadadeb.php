                                        ...
                                        <div class="text-center col bg-white px-6 py-8 rounded-xl mr-7 mb-7">
                                            <span class="svg-icon svg-icon-3x svg-icon-dark d-block my-2">
                                                ...
                                                <a href="" class="text-dark font-weight-bolder font-size-h2">
                                                    <?php echo e(DB::table('users')->get()->count()); ?> Users</a>
                                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel pros\travelAPI\resources\views/dashboard/index.blade.php ENDPATH**/ ?>