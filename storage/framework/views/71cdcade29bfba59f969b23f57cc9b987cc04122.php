                            ...
                            <div class="row m-0">
                                ...
                                <?php if($type == "franchisor"): ?>
                                    ...
                                    <div class="text-center col bg-white px-6 py-8 rounded-xl mr-7 mb-7">
                                        ...
                                        <a href="" class="text-dark font-weight-bolder font-size-h2">
                                            <?php echo e(DB::table('users')->where('plan_id' , 1)->count()); ?> Base Plan</a>
                                    </div>
                                <?php else: ?>
                                    <div class="text-center col bg-white px-6 py-8 rounded-xl mr-7 mb-7">
                                            <span class="svg-icon svg-icon-3x svg-icon-dark d-block my-2">
                    ...
                    <div class="table-responsive">
                        <table class="table table-head-custom table-vertical-center order-table kt_datatable" id="kt_advance_table_widget_1">
                            ...
                            <tr>
                                ...
                                <td >
                                    <span class="text-muted  font-weight-bold"><?php echo e($row['last_login']); ?>  </span>
                                </td>
                                ...
                                <div  class="row form-group">
                                    ...
                                    <?php if($type == "franchisor"): ?>
                                        <div class="col-12 col-md-12">
                                            <br>
                                            <label  class=" form-control-label">Brand Name</label>
                                            <input  type="text" class="form-control" name="brand_name" value="<?php echo e($row['brand_name']); ?>">
                                        </div>
                                    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ahmedafifi/Desktop/franshiseManagement/resources/views/dashboard/users.blade.php ENDPATH**/ ?>