                            ...
                            <div class="row m-0">
                                ...
                                @else
                                    ...
                                    <div class="text-center col bg-white px-6 py-8 rounded-xl mr-7 mb-7">
                                        ...
                                        <a href="" class="text-dark font-weight-bolder font-size-h2">
                                            {{ $total_inactive }}  Inactive {{ $type }}</a>
                                    </div>
                                @endif
                    ...
                    <form class="form" method="POST" action="{{ route('user.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div  class="row form-group">
                                ...
                                <input hidden type="text" class="form-control  " name="type" value="{{ request()->segment(3) }}">
