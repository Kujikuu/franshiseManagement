                        ...
                        <table class="table table-head-custom table-vertical-center order-table kt_datatable" id="kt_advance_table_widget_1">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#delete_record_modal" data-action="{{ route('lead.delete' , $row->id) }}" data-id="{{ $row->id }}" class="open_delete_modal btn btn-icon btn-light btn-hover-primary btn-sm">
                                        <span class="svg-icon svg-icon-md svg-icon-primary">
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form class="form" method="POST" action="{{ route('lead.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                ...
                                <div  class="row form-group">
                                    ...
                                    <div class="col-12 col-md-12">
                                        <br>
                                        <label  class=" form-control-label">First Name</label>
                                        <input required   type="text" class="form-control  " name="first_name" value="{{ $row['first_name'] }}">
                                    </div>

                                    <div class="col-12 col-md-12">
                                        <br>
                                        <label  class=" form-control-label">Last Name</label>
                                        <input required   type="text" class="form-control  " name="last_name" value="{{ $row['last_name'] }}">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-12">
                                        <br>
                                        <label  class=" form-control-label">Contact Number</label>
                                        <input required  type="text" class="form-control  " name="contact_number" value="{{ $row['contact_number'] }}">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-12">
                                        <br>
                                        <label  class=" form-control-label">Province</label>
                                        <input   type="text" class="form-control  " name="province" value="{{ $row['province'] }}">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-12">
                                        <br>
                                        <label  class=" form-control-label">lead source</label>
                                        <input   type="text" class="form-control  " name="lead_source" value="{{ $row['lead_source'] }}">
                                    </div>

                                    <div class="col-12 col-md-12">
                                        <br>
                                        <label  class=" form-control-label">lead status</label>
                                        <input   type="text" class="form-control  " name="lead_status" value="{{ $row['lead_status'] }}">
                                    </div>

                                    <div class="col-12 col-md-12">
                                        <br>
                                        <label  class=" form-control-label">lead owner</label>
                                        <input   type="text" class="form-control  " name="lead_owner" value="{{ $row['lead_owner'] }}">
                                    </div>

                                    <div class="col-12 col-md-12">
                                        <br>
                                        <label  class=" form-control-label">note</label>
                                        <input   type="text" class="form-control  " name="note" value="{{ $row['note'] }}">
                                    </div>
