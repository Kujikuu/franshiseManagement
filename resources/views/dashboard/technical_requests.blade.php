        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h2 style="color: #3a384e"  class="d-flex align-items-center font-weight-bolder my-1 mr-3">Technical Requests</h2>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
            ...
            <div class="card card-custom gutter-b">
                ...
                <div class="card-header border-0 py-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label font-weight-bolder text-dark">Technical Requests</span>
                    ...
                    <div class="table-responsive">
                        <table class="table table-head-custom table-vertical-center order-table kt_datatable" id="kt_advance_table_widget_1">
                            ...
                            <tr class="text-left">
                                ...
                                <th style="min-width: 150px">Request Description</th>
                            ...
                            <tr>
                                ...
                                <td >
                                    <span class="text-muted  font-weight-bold">TR{{ $row['id']  }}  </span>
                                </td>

                                <td >
                                    <span class="text-muted  font-weight-bold">A{{ $row->user->id }}</span>
                                </td>
                                <td >
                                    <span class="text-muted  font-weight-bold">{{ $row->user->name }}</span>
                                </td>

                                <td >
                                    <span class="text-muted  font-weight-bold">{{ $row->user->type }}</span>
                                </td>

                                <td >
                                    <span class="text-muted  font-weight-bold">{{ $row['description'] }}</span>
                                </td>
                                ...
                                <td >
                                    <span class="text-muted  font-weight-bold">{{ $row['created_at']  }}  </span>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#delete_record_modal" data-action="{{ route('technical_request.delete' , $row->id) }}" data-id="{{ $row->id }}" class="open_delete_modal btn btn-icon btn-light btn-hover-primary btn-sm">
                                        <span class="svg-icon svg-icon-md svg-icon-primary">
        ...
        {{--<div class="modal-dialog modal-dialog-centered modal-md" role="document">--}}
            {{--<div class="modal-content">--}}
                ...
                {{--<div class="modal-body">--}}
                    {{--<!--begin::Form-->--}}
                    {{--<form class="form" method="POST" action="{{ route('city.store') }}" enctype="multipart/form-data">--}}
                        {{--@csrf--}}
            ...
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form" method="POST" action="{{ route('technical_request.store') }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <select name="status" class="form-control">
                                            ...
                                            <option @if($row['status'] == "completed") selected @endif >completed</option>
                                        </select>
                                    </div>
                                </div>
